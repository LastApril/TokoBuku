...
public void clear() {
    ...
    private void initComponents() {
        ...
        setTitle("Toko Buku - Distributor");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            st = conn.createStatement();
            String sql = "delete from distributor where id_distributor = '"+jTextField1.getText()+"'";
    ...
    try {
        koneksi();
        st = conn.createStatement();
        String sql = "select * from distributor where id_distributor = '"+jTextField5.getText()+"'";
        rs = st.executeQuery(sql);
        while(rs.next()) {
            table.addRow(new Object[] {
                rs.getString(1),
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            koneksi();
            String sql = "update distributor set nama_distributor = ?, alamat = ?, telepon = ? where "
                    + "id_distributor = ?";
            ps = conn.prepareStatement(sql);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            File file = new File("src/report/distributor.jasper");
